...
%-----------------------------------------------------------------
\usepackage[a4paper,top=4cm,headsep=0cm,headheight=1.5cm,bottom=2.5cm,left=4cm,right=2.5cm,marginparwidth=0cm,default]{geometry}
...
\title{Your Paper}
\author{Fezeu Ghomsi Eugene Clotaire}
